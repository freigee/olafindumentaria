...
(function () {
  ...
  ready(function () {
    ...
    var lb = (function() {
      ...
      el.setAttribute('aria-label', 'Foto del producto');
      el.hidden = true;
      el.innerHTML =
        '<button id="lbClose" aria-label="Cerrar foto">✕</button>' +
    ...
    safe(function initProductos() {
      ...
      function crearCard(p) {
        ...
        if (imgEl) {
          ...
          imgEl.addEventListener('click', function() { lb.open(imgEl.src, p.nombre); });
        }
